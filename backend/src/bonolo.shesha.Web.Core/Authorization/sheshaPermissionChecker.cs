...
namespace bonolo.shesha.Common.Authorization
{
    /// <summary>
    /// shesha Permission checker
    /// </summary>
    public class sheshaPermissionChecker : ICustomPermissionChecker, IsheshaPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public sheshaPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
