...
using bonolo.shesha.Tests.DependencyInjection;
using Shesha;
...
namespace bonolo.shesha.Common.Tests
{
    [DependsOn(
        typeof(sheshaModule),
    ...
    public class sheshaCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public sheshaCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
